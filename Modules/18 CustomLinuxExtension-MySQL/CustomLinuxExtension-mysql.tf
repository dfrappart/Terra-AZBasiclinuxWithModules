###################################################################################
#This module allows the creation of n CustomLinuxExtension and install mysql
###################################################################################
...
resource "azurerm_virtual_machine_extension" "Terra-CustomScriptLinuxAgent" {
  ...
  settings = <<SETTINGS
        ...
        "fileUris": [ "https://raw.githubusercontent.com/dfrappart/Terra-AZBasiclinuxWithModules/master/Scripts/installmysql.sh" ],
